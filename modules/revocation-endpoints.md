...
**Core rule lives in:** [`Agentic-AI-Agent-Instructions.md` §7.2](../Agentic-AI-Agent-Instructions.md#7-security).
...
If the access token gates `POST /logout`, a user with an expired access token can't log out. Their session lingers until expiry, which defeats the point of logout. Same anti-pattern applies to:
